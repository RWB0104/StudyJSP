...
<head>
	...
	<script src="/ShoppingMall/js/shop/bookContent.js"></script>
</head>
		...
		<table class="vhcenter">
			<tr height="30">
				<td rowspan="6" width="150">
					<img src="/ShoppingMall/images/bookImage/${book.getBook_image()}" class="contentimage" />
				</td>
