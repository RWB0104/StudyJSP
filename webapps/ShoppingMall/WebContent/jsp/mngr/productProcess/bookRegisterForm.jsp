...
<head>
	...
	<script src="/ShoppingMall/js/mngr/productProcess/bookRegist.js"></script>
</head>
...
<body>
	...
	<form action="/ShoppingMall/mg/bookRegisterPro.do" method="POST" id="upForm1" enctype="multipart/from-data">
		<div id="bookRegisterForm" class="box">
			<ul>
				...
				<li>
					...
					<input type="text" id="book_title" name="book_title" size="50" placeholder="제목" maxlength="50" />
				</li>
				
				<li>
					<label for="book_price">가격</label>
					<input type="text" id="book_price" name="book_price" size="10" placeholder="가격" maxlength="9" />원
				</li>
				
				<li>
					<label for="book_count">수량</label>
					<input type="text" id="book_count" name="book_count" size="10" placeholder="수량" maxlength="5" />권
				</li>
				
				<li>
					<label for="author">저자</label>
					<input type="text" id="author" name="author" size="20" placeholder="저자" maxlength="30" />
				</li>
				
				<li>
					<label for="publishing_com">출판사</label>
					<input type="text" id="publishing_com" name="publishing_com" size="20" placeholder="출판사" maxlength="30" />
				</li>
				...
				<li class="label2">
					<input type="submit" id="registBook" value="재등록" />
				</li>
			</ul>
		</div>
	</form>
