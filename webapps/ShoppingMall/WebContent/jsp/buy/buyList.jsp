...
<head>
	...
	<script src="/ShoppingMall/js/buy/buyList.js"></script>
</head>
			...
			<c:forEach var="i" begin="0" end="${buyLists.size() - 1}">
				...
				<table>
					...
					<tr>
						...
						<td width="300">
							<img src="/ShoppingMall/images/bookImage/${buylist.getBook_image()}" class="cartimage" />${buylist.getBook_title()}
						</td>
				...
				<c:if test="${pid != nid}">
					<p align="right" class="b">
						주문금액: <fmt:formatNumber value="${total}" type="number" pattern="#,##0" />원
					</p>
